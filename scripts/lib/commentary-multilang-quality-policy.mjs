...
export const VERIFIED_MULTILANG_SCOPE = Object.freeze({
  bookId: 'genesis',
  chapter: 1,
  verseFrom: 1,
  verseTo: 10,
...
export const CONTAINED_MULTILANG_SCOPE = Object.freeze({
  bookId: 'genesis',
  chapter: 1,
  verseFrom: 11,
  verseTo: 31,
...
export const MULTILANG_QUALITY_CRITERIA = Object.freeze([
  Object.freeze({
    id: 'card_count_match',
...
export function normalizeCommentaryLocale(localeOrLang) {
...
export function isMultilangLocale(localeOrLang) {
 ...
 */
export function isContainedUnverifiedMultilangVerse({
  bookId,
  chapter,
  verse,
  locale,
...
export function isVerifiedMultilangVerse({ bookId, chapter, verse, locale } = {}) {
  if (!isMultilangLocale(locale)) return false;
