...
(function (global) {
  ...
  var STRINGS = {
    ko: {
      ...
      'home.card.listen': '듣기',
      'home.notify.autoReceive': '알림 자동 수신하기',
      'home.notify.time': '알림 시간',
      'home.notify.timeLead': '언제 오늘의 말씀을 받아볼까요?',
      'home.notify.customTime': '직접 선택',
      'home.notify.recommended': '추천',
      'home.notify.frequency': '알림 방식',
      'home.notify.once': '하루 1회',
      'home.notify.twice': '하루 2회',
      'home.notify.first': '첫 번째 알림',
      'home.notify.second': '두 번째 알림',
      'home.notify.secondTimeTitle': '두 번째 알림 시간',
      'home.notify.secondTimeLead': '두 번째 말씀은 언제 받아볼까요?',
      'home.notify.intervalStart': '수신 시작 시간',
      'home.notify.intervalEnd': '수신 종료 시간',
      'home.notify.intervalStartLead': '몇 시부터 말씀을 받을까요?',
      'home.notify.intervalEndLead': '몇 시까지 말씀을 받을까요?',
      'home.notify.everyHours': '{hours}시간마다',
      'home.notify.perDayCount': '하루 최대 {count}회',
      'home.notify.saveFail': '설정을 저장하지 못했습니다. 다시 시도해 주세요.',
      'home.notify.installFirst': '먼저 앱을 설치해 주세요',
      'home.notify.installFirstBody': '설치가 끝나면 홈 화면의 은혜의말씀을 다시 열어주세요.',
      'home.notify.installNeeded': '홈 화면 앱 추가 필요',
      'home.notify.permissionStepTitle': '2단계 · 말씀 알림 켜기',
      'home.notify.installedMilestone': '홈 화면에 추가하셨습니다',
      'home.notify.installedMilestoneBody': '은혜의말씀 앱 설치가 완료되었습니다. 이제 마지막으로 말씀 알림을 켜주세요.',
      'home.notify.lastStep': '마지막 단계',
      'home.notify.permissionGuideTitle': '알림을 허용해 주세요',
      'home.notify.permissionGuideBody': '아래 버튼을 누르면 iPhone의 알림 허용 창이 열립니다.',
      'home.notify.turnOn': '알림 켜기',
      'home.notify.activeTitle': '오늘의 말씀 알림 설정',
      'home.notify.activeMilestone': '말씀 알림이 설정되었습니다',
      'home.notify.activeMilestoneBody': '아래에서 받는 시간과 알림 방식을 선택할 수 있습니다.',
      'home.notify.blockedTitle': '알림 허용 확인',
      'home.notify.blockedMilestone': '알림 허용이 꺼져 있습니다',
      'home.notify.blockedMilestoneBody': '기기 설정에서 은혜의말씀 알림을 다시 허용할 수 있습니다.',
    ...
    en: {
      ...
      'home.notify.autoReceive': 'Automatic notifications',
      ...
      'home.notify.frequency': 'Notification schedule',
      ...
      'home.notify.secondTimeTitle': 'Second notification time',
      'home.notify.secondTimeLead': 'When should the second Word arrive?',
      'home.notify.intervalStart': 'Delivery start time',
      'home.notify.intervalEnd': 'Delivery end time',
      'home.notify.intervalStartLead': 'What time should delivery begin?',
      'home.notify.intervalEndLead': 'What time should delivery end?',
      'home.notify.everyHours': 'Every {hours} hours',
      'home.notify.perDayCount': 'Up to {count} times a day',
      'home.notify.saveFail': 'Couldn’t save the setting. Please try again.',
      'home.notify.installFirst': 'Install the app first',
      'home.notify.installFirstBody': 'When installation is complete, open Words of Grace from your Home Screen.',
      'home.notify.installNeeded': 'Add Home Screen app',
      'home.notify.permissionStepTitle': 'Step 2 · Turn on notifications',
      'home.notify.installedMilestone': 'Added to your Home Screen',
      'home.notify.installedMilestoneBody': 'The app is installed. One last step: turn on Word notifications.',
      'home.notify.lastStep': 'Final step',
      'home.notify.permissionGuideTitle': 'Allow notifications',
      'home.notify.permissionGuideBody': 'Tap the button below to open the notification permission prompt.',
      'home.notify.turnOn': 'Turn on notifications',
      'home.notify.activeTitle': 'Today’s Word notification settings',
      'home.notify.activeMilestone': 'Word notifications are set',
      'home.notify.activeMilestoneBody': 'Choose delivery times and a notification schedule below.',
      'home.notify.blockedTitle': 'Check notification permission',
      'home.notify.blockedMilestone': 'Notification permission is off',
      'home.notify.blockedMilestoneBody': 'You can allow Words of Grace notifications again in device settings.',
    ...
    ja: {
      ...
      'home.card.listen': '聴く',
      'home.notify.autoReceive': '通知を自動受信する',
      'home.notify.time': '通知時刻',
      'home.notify.timeLead': '今日のみことばは、いつ受け取りますか？',
      'home.notify.customTime': '時刻を指定',
      'home.notify.recommended': 'おすすめ',
      'home.notify.frequency': '通知方法',
      'home.notify.once': '1日1回',
      'home.notify.twice': '1日2回',
      'home.notify.first': '1回目の通知',
      'home.notify.second': '2回目の通知',
      'home.notify.secondTimeTitle': '2回目の通知時刻',
      'home.notify.secondTimeLead': '2回目のみことばは、いつ受け取りますか？',
      'home.notify.intervalStart': '受信開始時刻',
      'home.notify.intervalEnd': '受信終了時刻',
      'home.notify.intervalStartLead': '何時から受け取りますか？',
      'home.notify.intervalEndLead': '何時まで受け取りますか？',
      'home.notify.everyHours': '{hours}時間ごと',
      'home.notify.perDayCount': '1日最大{count}回',
      'home.notify.saveFail': '設定を保存できませんでした。もう一度お試しください。',
      'home.notify.installFirst': 'まずアプリをインストールしてください',
      'home.notify.installFirstBody': '完了したら、ホーム画面から恵みのみことばを開いてください。',
      'home.notify.installNeeded': 'ホーム画面への追加が必要',
      'home.notify.permissionStepTitle': 'ステップ2・通知をオンにする',
      'home.notify.installedMilestone': 'ホーム画面に追加されました',
      'home.notify.installedMilestoneBody': 'アプリのインストールが完了しました。最後に通知をオンにしてください。',
      'home.notify.lastStep': '最後のステップ',
      'home.notify.permissionGuideTitle': '通知を許可してください',
      'home.notify.permissionGuideBody': '下のボタンを押すと通知の許可画面が開きます。',
      'home.notify.turnOn': '通知をオンにする',
      'home.notify.activeTitle': '今日のみことば通知設定',
      'home.notify.activeMilestone': 'みことば通知が設定されました',
      'home.notify.activeMilestoneBody': '下で受信時刻と通知方法を選択できます。',
      'home.notify.blockedTitle': '通知許可を確認',
      'home.notify.blockedMilestone': '通知許可がオフです',
      'home.notify.blockedMilestoneBody': '端末の設定から通知を再度許可できます。',
    ...
    zh: {
      ...
      'home.card.listen': '收听',
      'home.notify.autoReceive': '自动接收通知',
      'home.notify.time': '通知时间',
      'home.notify.timeLead': '希望何时收到今日的话语？',
      'home.notify.customTime': '自行选择',
      'home.notify.recommended': '推荐',
      'home.notify.frequency': '通知方式',
      'home.notify.once': '每天 1 次',
      'home.notify.twice': '每天 2 次',
      'home.notify.first': '第一次通知',
      'home.notify.second': '第二次通知',
      'home.notify.secondTimeTitle': '第二次通知时间',
      'home.notify.secondTimeLead': '第二次希望何时收到今日话语？',
      'home.notify.intervalStart': '接收开始时间',
      'home.notify.intervalEnd': '接收结束时间',
      'home.notify.intervalStartLead': '从几点开始接收？',
      'home.notify.intervalEndLead': '接收到几点为止？',
      'home.notify.everyHours': '每{hours}小时',
      'home.notify.perDayCount': '每天最多{count}次',
      'home.notify.saveFail': '设置未能保存，请再试一次。',
      'home.notify.installFirst': '请先安装应用',
      'home.notify.installFirstBody': '安装完成后，请从主屏幕重新打开恩典话语。',
      'home.notify.installNeeded': '需要添加主屏幕应用',
      'home.notify.permissionStepTitle': '第 2 步 · 开启通知',
      'home.notify.installedMilestone': '已添加到主屏幕',
      'home.notify.installedMilestoneBody': '应用安装已完成。最后请开启话语通知。',
      'home.notify.lastStep': '最后一步',
      'home.notify.permissionGuideTitle': '请允许通知',
      'home.notify.permissionGuideBody': '点击下方按钮即可打开通知权限窗口。',
      'home.notify.turnOn': '开启通知',
      'home.notify.activeTitle': '今日话语通知设置',
      'home.notify.activeMilestone': '话语通知已设置',
      'home.notify.activeMilestoneBody': '可在下方选择接收时间和通知方式。',
      'home.notify.blockedTitle': '检查通知权限',
      'home.notify.blockedMilestone': '通知权限已关闭',
      'home.notify.blockedMilestoneBody': '可在设备设置中重新允许恩典话语通知。',
