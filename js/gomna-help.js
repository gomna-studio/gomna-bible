...
(function () {
      ...
      items: [
        ...
        },
        {
          ...
          body: [
            ...
            ['note', '말씀풀이는 원어, 역사적 배경, 신학적 의미, 성경 유형론, 매튜헨리 주석, 설교, 찬송가, 상담, 교차참조의 아홉 관점을 제공합니다.']
          ]
        },
        {
          id: 'search',
          ...
          label: '말씀 찾기',
          body: [
            ['p', '화면 아래의 찾기를 누른 뒤 검색창에 찾고 싶은 단어나 책 이름을 입력하세요. 로마서 8장처럼 책과 장을 입력해 바로 이동할 수도 있습니다.'],
        ...
        },
        {
          ...
          label: '홈 말씀 카드 이용하기',
          body: [
            ['p', '홈에는 오늘의 말씀, 오늘의 묵상과 삶, 성경 속 이야기와 인물 카드가 차례로 나타납니다. 카드를 누르면 자세한 두 번째 화면이 열립니다.'],
            ['p', '자세한 화면에서는 본문 보기, 말씀풀이, 듣기 또는 말씀 보기를 이용할 수 있습니다.'],
            ['p', '휴대폰에서 두 손가락으로 카드를 벌리면 카드와 글씨가 함께 확대됩니다. 확대된 카드는 한 손가락으로 옮겨 볼 수 있고, 한 번 누르면 원래 크기로 돌아옵니다.']
          ]
        },
        {
          id: 'meditation',
          ...
          label: '오늘의 묵상과 기록',
          body: [
            ['p', '화면 아래의 묵상에서 오늘의 말씀, 묵상 글, 묵상 질문, 오늘의 한 걸음과 기도를 차례로 볼 수 있습니다.'],
            ['p', '오늘 내 마음 기록을 적어 저장하고 오늘의 묵상을 마치면, 이번 주 말씀 동행과 지난 묵상 기록에서 다시 볼 수 있습니다.'],
            ['note', '묵상 기록은 현재 이 기기의 해당 계정에 저장됩니다. 계정 기록 동기화 항목에는 아직 포함되지 않습니다.']
          ]
        },
        {
          id: 'archive-resume',
      ...
      items: [
        {
          ...
          body: [
            ...
            ['p', '로그인한 뒤에는 화면 아래의 나를 눌러 프로필과 계정 기능을 이용할 수 있습니다.']
          ]
        },
        {
          id: 'sync',
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          body: [
            ['h', '말씀 알림'],
            ['p', '홈 위쪽의 종 모양을 누르면 오늘의 말씀 알림을 켜고, 받을 시간과 알림 방식을 정하거나 테스트 알림을 보낼 수 있습니다.'],
            ['p', '알림이 차단되어 있으면 화면에 안내되는 기기 또는 브라우저 설정에서 은혜의말씀 알림을 허용해 주세요.'],
            ['h', '말씀 이메일'],
            ['p', '홈 위쪽의 편지 모양을 누르면 이메일 주소와 받을 시간을 정해 오늘의 말씀을 매일 받을 수 있습니다. 수신 동의가 필요하며 언제든 끌 수 있습니다.']
          ]
        },
        {
          id: 'install',
        ...
        },
        {
          ...
          label: '쿠키와 앱 정보',
          body: [
            ['p', '내 정보 → 설정 → 쿠키 및 분석 설정에서 방문 통계 수집 동의를 다시 선택할 수 있습니다. 거부해도 앱 이용에는 제한이 없습니다.'],
            ['p', '설정의 앱 정보에서 개인정보처리방침과 서비스 이용약관을 확인할 수 있습니다. 홈 맨 아래의 소개·문의·개인정보·이용약관에서도 바로 열 수 있습니다.']
          ]
        }
      ]
    },
  ...
  /* 로컬 확인 전용: 로그인하지 않아도 ?gomnaHelp=1 로 도움말을 바로 연다.
     운영 도메인에서는 이 시험값을 완전히 무시한다. */
  function openLocalPreview() {
    ...
    if (!local) return;
    try {
      if (new URLSearchParams(window.location.search || '').get('gomnaHelp') === '1') open();
    } catch (e) {}
  }
  if (document.readyState === 'loading') document.addEventListener('DOMContentLoaded', openLocalPreview, { once: true });
  else window.setTimeout(openLocalPreview, 0);
})();
