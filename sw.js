...
const CACHE_VERSION = '2026-09-19-pwa-commentary-recovery-v54';
...
const STATIC_URLS = [
  ...
  '/js/audio-config.js?v=20260919-book-manifest-v52',
  '/js/audio-engine.js?v=20260919-book-manifest-v52',
